...
export default function TrustIndicators() {
  return (
    <section className="py-24 bg-gradient-to-b from-gray-950 to-[#0b101b] text-white relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-0 w-96 h-96 bg-gradient-to-br from-lime-500/14 to-transparent rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 right-0 w-96 h-96 bg-gradient-to-br from-lime-500/10 to-transparent rounded-full blur-3xl" />
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={stat.label} className="group text-center" style={{ animationDelay: `${index * 100}ms` }}>
                <div className="relative">
                  <div className="absolute inset-0 bg-gradient-to-r from-lime-500/18 to-lime-600/18 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
