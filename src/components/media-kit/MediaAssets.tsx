        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10">
          {items.map((item) => (
            ...
            >
              ...
              <button className="inline-flex items-center justify-center rounded-full px-4 py-2 text-xs sm:text-sm font-medium bg-lime-500 hover:bg-lime-600 text-white transition">
                Request Access
              </button>
            </div>
          ))}
